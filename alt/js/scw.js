...
//******************************************************************************
    ...
    function scwSetDefaultLanguage()
     ...
     function scwSetLanguage()
        {switch (scwLanguage)
			...
			case 'cr':
				// Croatian (provided by Amir Dupanovic)
				scwToday               = 'Danas:';
                scwClear               = 'Clear';
    ...
    var scwDateDisplayFormat =  'DD MMM YYYY'; //'dd-mm-yy';     // e.g. 'MMM-DD-YYYY' for the US

    // Output date format

    var scwDateOutputFormat  =  'yyyy-mm-dd'; //'DD MMM YYYY'; // e.g. 'MMM-DD-YYYY' for the US
